...
Character creator is a simple tool to create new character tokens for Shadowdark RPG system. You can initialize it by clicking new button added to "Token Controls" menu.
